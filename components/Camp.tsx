  ...
  return (
    <section className=' 2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20' >
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-4 lg:max-w-[400px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl ">
          <h2 className="regular-24 md:regular-34 2xl:regular-64 capitalize text-white">
          ...
          <p className="regular-14 xl:regular-18 mt-5 text-white">
            ...
            very large. That's why we are here for those who want to start 
            an adventure.
